...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <!-- Icono tarjetas de colores-->
            <div class="row">
            <div class="col-xl-3 col-sm-6 mb-3 mt-5 ">
              <div class="card text-black bg-info o-hidden h-100">
                <div class="card-body">
                  <div class="card-body-icon">
                    <i class="fas fa-fw fa-comments"></i>
                  </div>
                  <div class="mr-6">Empleados!</div>
                </div>
                <a class="card-footer text-black clearfix small z-1" href="empleados">
            ...
            <div class="col-xl-3 col-sm-6 mb-3 mt-5">
              <div class="card text-black bg-warning o-hidden h-100">
                ...
                <a class="card-footer text-black clearfix small z-1" href="productos">
                  <span class="float-left">Ver Detalles</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
